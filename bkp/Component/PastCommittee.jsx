...
import HariOm from '../Images/Current/DrHariOmBomb.jpeg';

export default function PastCommittee() {
    ...
    return (
        <div>
            <div className='container'>
                <div className='row'>
                    <p className='text-start text-decoration-underline' style={{ fontWeight: 500, fontSize: '1.4em', color: "#154360" }}>Past Committee</p>
                    {
