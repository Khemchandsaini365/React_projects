            ...
            <div className=''>
                <div className='container-fluid'>
                    <div className='row d-flex justify-content-between align-items-center' >
                        <div className='col-4 text-start' style={{ fontSize: "26px", fontWeight: 400, color: '#fff' }}>All Users</div>
                        <div className='col-4'>
                            <TextField
                                label="Search"
                                //    value={}
                        ...
                        <div onClick={handleShow} className='col-2 d-flex justify-content-center align-items-center p-2 rounded-1 me-3' style={{ backgroundColor: "#f1f1f1", fontWeight: 400, color: "#000", cursor: "pointer" }}>+ Add</div>
                    </div>
                                            ...
                                            <Table stickyHeader aria-label="sticky table" size="small">
                                                <TableHead>
                                                    <TableRow>
                                                        ...
                                                        <TableCell sx={{ fontWeight: "600", minWidth: 50, fontSize: "14px" }}>Time Period</TableCell>
