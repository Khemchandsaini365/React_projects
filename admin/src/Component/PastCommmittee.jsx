...
export default function PastCommmittee() {
            ...
            <div className=''>
                <div className='container-fluid'>
                    <div className='row d-flex justify-content-between align-items-center' >
                        <div className='col-4 text-start' style={{ fontSize: "26px", fontWeight: 400, color: '#566573' }}>Past committee</div>
                        <div className='col-4'>
                            <TextField
                                label="Search"
                                //    value={}
                                ...
                                <div className="table-responsive">
                                    ...
                                    <Modal show={show} onHide={handleClose} size="lg" aria-labelledby="example-modal-sizes-title-lg">
                                        <Modal.Header closeButton>
                                            <Modal.Title>Past committee</Modal.Title>
                                        </Modal.Header>
                                        <Modal.Body>
                                            <div className='container-fluid'>
                                                <div className='row'>
