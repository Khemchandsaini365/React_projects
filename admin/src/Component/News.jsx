            ...
            <div className='scroll-box'>
                <div className='container-fluid g-0 mt-3'>
                    <div className='row d-flex justify-content-between align-items-center mb-2 g-0 py-2' >
                        <div className='col-4 text-start' style={{ fontSize: "20px", fontWeight: 600, color: '#566573' }}>News</div>
                        <div className='col-4'>
                            <TextField
                                label="Search"
                                //    value={}
                                    ...
                                    <Paper sx={{ width: '100%' }}>
                                        <TableContainer sx={{ mt: -1 }}>
                                            <Table stickyHeader aria-label="sticky table" size="small">
                                                <TableHead>
                                                    <TableRow>
                                                        <TableCell sx={{ fontWeight: "600", minWidth: 50, fontSize: "14px" }}>News Title</TableCell>
                                                        <TableCell sx={{ fontWeight: "600", minWidth: 50, fontSize: "14px" }}>News Description</TableCell>
                                                        <TableCell sx={{ fontWeight: "600", minWidth: 50, fontSize: "14px" }}>Action</TableCell>
                                                    </TableRow>
                                                </TableHead>
                                                <TableBody>
                                                    <TableRow>
                                                        <TableCell sx={{ fontWeight: "500", minWidth: 50, fontSize: "12px" }}>News Title</TableCell>
                                                        <TableCell sx={{ fontWeight: "500", minWidth: 50, fontSize: "12px" }}>News Description</TableCell>
                                            ...
                                            <div className='container-fluid'>
                                                <div className='row'>
                                                    <div className='col-lg-4 col-md-6 col-sm-12'>
                                                        <div className='' style={{ fontSize: "13px", color: '#1f5156', fontWeight: 600 }}>News Title</div>
                                                        <input className='sercc-inpt p-1' type='text' placeholder="News Title" autoFocus required style={{ width: "100%" }} />
                                                    </div>
                                                    <div className='col-lg-4 col-md-6 col-sm-12'>
                                                        <div className='' style={{ fontSize: "13px", color: '#1f5156', fontWeight: 600 }}>News Description</div>
                                                        <input className='sercc-inpt p-1' type='text' placeholder="News Description" autoFocus required style={{ width: "100%" }} />
                                                    </div>
                                                    <div className='col-lg-4 col-md-6 col-sm-12'>
