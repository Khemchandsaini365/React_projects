            ...
            <div className='scroll-box'>
                <div className='container-fluid g-0 mt-3'>
                    <div className='row d-flex justify-content-between align-items-center mb-2 g-0 py-2' >
                        <div className='col-4 text-start' style={{ fontSize: "20px", fontWeight: 600, color: '#566573' }}>Circular Notice</div>
                        <div className='col-4'>
                            <TextField
                                label="Search"
                                //    value={}
                                ...
                                <div className="table-responsive">
                                            ...
                                            <Table stickyHeader aria-label="sticky table" size="small">
                                                <TableHead>
                                                    <TableRow>
                                                        ...
                                                        <TableCell sx={{ fontWeight: "600", minWidth: 50, fontSize: "14px" }}>File</TableCell>
                                                ...
                                                <TableBody>
                                                    <TableRow>
                                                        ...
                                                        <TableCell sx={{ fontWeight: "500", minWidth: 50, fontSize: "12px" }}>File</TableCell>
                                    ...
                                    <Modal show={show} onHide={handleClose} size="lg" aria-labelledby="example-modal-sizes-title-lg">
                                        <Modal.Header closeButton>
                                            <Modal.Title>Circular Notice</Modal.Title>
                                        </Modal.Header>
                                        <Modal.Body>
                                            <div className='container-fluid'>
                                                <div className='row'>
                                                    ...
                                                    <div className='col-lg-6 col-md-6 col-sm-12'>
                                                        <div className='' style={{ fontSize: "13px", color: '#1f5156', fontWeight: 600 }}>File</div>
                                                        <input className='sercc-inpt p-1' type='file' accept="application/pdf" placeholder="File" autoFocus required style={{ width: "100%" }} />
                                                    </div>
                                                </div>
